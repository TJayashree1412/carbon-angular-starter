...
export class ViewIbmiComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.model.totalDataLength = this.contactsList.length;
  ...
  for (const datum of data) {
      ...
      newData.push([new TableItem({ data: {name: datum.resource , link: "/editIBMI"}, template: this.customTableItemTemplate}),
